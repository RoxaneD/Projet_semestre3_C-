...
class SymboleValue : public Symbole,public Noeud { // Un symbole valué est un symbole qui a une valeur (définie ou pas) et c'est aussi une feuille de l'arbre abstrait
public:
